...
namespace ODExplorer.OrganicData
{
    ...
    public partial class BioDataView : Window
    {
        ...
        private void DeleteBodyData_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBoxResult result = MessageBox.Show($"Do you want to delete scan data for {deleteme.SystemName}?",
                  "Confirmation",
        ...
        {
            MessageBoxResult result = MessageBox.Show("Do you want to clear all biological scan data?",
                              "Confirmation",
                              MessageBoxButton.YesNo,
                              MessageBoxImage.Question);
